...
@interface BLCImageTableViewController () <BLCMediaTableViewCellDelegate, UIViewControllerTransitioningDelegate, UIGestureRecognizerDelegate, UIScrollViewDelegate, BLCCameraViewControllerDelegate>
